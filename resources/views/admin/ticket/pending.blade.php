    ...
    layui.use(['form', 'table','miniPage','element'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'activity_id', width: 180, title: '{{__("home.ticket.activity")}}'},
                {field: 'data', width: 150, title: '{{__("home.ticket.data")}}'},
                {field: 'bonus', width: 120, title: '{{__("home.ticket.bonus")}}'},
                {field: 'ip_address', width:120, title: '{{__("home.ticket.ip")}}',},
                {field: 'created_at', width:180, title: '{{__("home.created_at")}}'},
                {field: 'status', width: 150, title: '{{__("home.status")}}', sort: true},
